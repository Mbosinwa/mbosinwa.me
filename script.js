...
╚═╝      ╚═════╝ ╚═╝  ╚═╝   ╚═╝   ╚═╝  ╚═╝╚══════╝`;
    ...
    const welcome =
      ...
      this.wrapWithColor(
        "         Mbosinwa Awunor — Interactive Terminal Resume\n",
        "#888888"
      ) +
      this.wrapWithColor(
...
${this.wrapWithColor("│", "#ff8c00")} ${this.wrapWithColor(
      "Mbosinwa Awunor — Senior Software Engineer with 11+ years",
      "#ffffff"
    )}
${this.wrapWithColor("│", "#ff8c00")} ${this.wrapWithColor(
      "building technology products for African businesses.",
      "#ffffff"
    )}
${this.wrapWithColor(
  "└─────────────────────────────────────────────────────────┘",
...
${this.wrapWithColor(
  "   Built SwitchTellerPay (2014) — e-payment brand of Emrinet",
  "#ffffff"
)}
${this.wrapWithColor(
...
${this.wrapWithColor("⚡ Architecture", "#ff8c00")}
${this.wrapWithColor(
  "   Microservices for distributed systems + modular monolith",
  "#ffffff"
)}
${this.wrapWithColor("   with async job processing patterns", "#ffffff")}
...
${this.wrapWithColor("│", "#ff8c00")} ${this.wrapWithColor(
      "Building impactful software for African businesses!",
      "#ffffff"
...
<span style="color: #00ffff;">PORTAL SOLUTIONS | Senior Software Engineer</span>
${this.wrapWithColor(
  "Dec 2021 - Present | Port Harcourt, Nigeria",
  "#ffffff"
)}
${this.wrapWithColor(
  "Custom web and mobile apps for Nigerian businesses",
  "#98fb98"
)}

• ${this.wrapWithColor("Fullstack developer", "#ffa07a")} - ${this.wrapWithColor(
      "Building scalable web and mobile products for clients",
      "#ffffff"
    )}
• ${this.wrapWithColor("Architecture", "#ffa07a")} - ${this.wrapWithColor(
      "Modular monolith with async job processing",
      "#ffffff"
    )}

${this.wrapWithColor("Technologies used:", "#00ffff")} ${this.wrapWithColor(
      "Go, TypeScript, React, Vue 3, Next.js, Node.js, Fly.io, Cloudflare, Supabase, PostgreSQL",
      "#87cefa"
    )}

<span style="color: #00ffff;">VENTRIPLUS | Software Engineer</span>
${this.wrapWithColor(
  "Dec 2023 - Present | Port Harcourt, Nigeria",
  "#ffffff"
)}
${this.wrapWithColor(
  "Multi-tenant POS & inventory platform for gadget stores and retail SMEs",
  "#98fb98"
)}

• ${this.wrapWithColor("SaaS product", "#ffa07a")} - ${this.wrapWithColor(
      "Multi-tenant architecture for retail businesses",
      "#ffffff"
    )}
• ${this.wrapWithColor("Inventory system", "#ffa07a")} - ${this.wrapWithColor(
      "Real-time stock tracking and POS integration",
      "#ffffff"
    )}

${this.wrapWithColor("Technologies used:", "#00ffff")} ${this.wrapWithColor(
      "Go, Node.js, React, PostgreSQL, Redis, Docker",
      "#87cefa"
    )}

<span style="color: #00ffff;">PREMIUM PENSION LIMITED | IT Support</span>
${this.wrapWithColor(
  "Jun 2017 – Apr 2018 | Port Harcourt, Nigeria",
  "#ffffff"
)}

• ${this.wrapWithColor("IT support", "#ffa07a")} - ${this.wrapWithColor(
      "Infrastructure management and system support",
      "#ffffff"
    )}

<span style="color: #00ffff;">EMRINET MOBILE LTD | Lead Developer</span>
${this.wrapWithColor(
  "Mar 2014 – Feb 2016 | Lagos, Nigeria",
  "#ffffff"
)}
${this.wrapWithColor(
  "SwitchTellerPay — e-payment brand, bill payments & money transfer",
  "#98fb98"
)}

• ${this.wrapWithColor("SwitchTellerPay", "#ffa07a")} - ${this.wrapWithColor(
      "Bill payment, bulk messaging, real-time transfers, airtime top-up",
      "#ffffff"
    )}
• ${this.wrapWithColor("Payment gateway", "#ffa07a")} - ${this.wrapWithColor(
      "Reduced transaction risk across all banks",
      "#ffffff"
    )}

${this.wrapWithColor("Technologies used:", "#00ffff")} ${this.wrapWithColor(
      "Node.js, JavaScript, MongoDB, Redis, NGINX",
      "#87cefa"
    )}

<span style="color: #00ffff;">WAPLOADED MEDIA | Senior Software Engineer</span>
${this.wrapWithColor(
  "Jul 2011 – Jul 2015 | Abuja, Nigeria",
  "#ffffff"
)}

• ${this.wrapWithColor("Core team", "#ffa07a")} - ${this.wrapWithColor(
      "Led tech decisions at Waploaded.com",
      "#ffffff"
    )}

<span style="color: #00ffff;">STATE SECRETARIAT ASABA | Systems & Network Admin</span>
${this.wrapWithColor(
  "2011 – 2012 | Asaba, Nigeria",
  "#ffffff"
)}

• ${this.wrapWithColor("Systems admin", "#ffa07a")} - ${this.wrapWithColor(
      "Coordination of all systems/networks and ensuring network security",
      "#ffffff"
    )}`;
...
${this.wrapWithColor("🏛️", "#ff8c00")} ${this.wrapWithColor("ND & HND in Computer Science", "#ffffff")}
${this.wrapWithColor("   Institution:", "#ff8c00")} ${this.wrapWithColor("Delta State Polytechnic Ogwashi-Uku", "#ffffff")}
${this.wrapWithColor("   Duration:", "#ff8c00")}    ${this.wrapWithColor("2012 - 2016", "#ffffff")}
${this.wrapWithColor("   Location:", "#ff8c00")}    ${this.wrapWithColor("Delta State, Nigeria", "#ffffff")}
${this.wrapWithColor("   Award:", "#ff8c00")}       ${this.wrapWithColor("Upper Credit", "#98fb98")}

${this.wrapWithColor("🏛️", "#ff8c00")} ${this.wrapWithColor("Post Graduate Degree in Computer Science", "#ffffff")}
${this.wrapWithColor("   Institution:", "#ff8c00")} ${this.wrapWithColor("Rivers State University", "#ffffff")}
${this.wrapWithColor("   Duration:", "#ff8c00")}    ${this.wrapWithColor("2025 - 2026", "#ffffff")}
${this.wrapWithColor("   Location:", "#ff8c00")}    ${this.wrapWithColor("Rivers State, Nigeria", "#ffffff")}

${this.wrapWithColor("🏛️", "#ff8c00")} ${this.wrapWithColor("Master of Science in Computer Science", "#ffffff")}
${this.wrapWithColor("   Institution:", "#ff8c00")} ${this.wrapWithColor("Rivers State University", "#ffffff")}
${this.wrapWithColor("   Status:", "#ff8c00")}      ${this.wrapWithColor("In View", "#ffa07a")}
${this.wrapWithColor("   Location:", "#ff8c00")}    ${this.wrapWithColor("Rivers State, Nigeria", "#ffffff")}

${this.wrapWithColor("🏛️", "#ff8c00")} ${this.wrapWithColor("Doctor of Philosophy in Computer Science", "#ffffff")}
${this.wrapWithColor("   Institution:", "#ff8c00")} ${this.wrapWithColor("Rivers State University", "#ffffff")}
${this.wrapWithColor("   Status:", "#ff8c00")}      ${this.wrapWithColor("In View", "#ffa07a")}
${this.wrapWithColor("   Location:", "#ff8c00")}    ${this.wrapWithColor("Rivers State, Nigeria", "#ffffff")}
...
${this.wrapWithColor("│", "#ff8c00")}${this.wrapWithColor(
      " Lifelong learner — from ND to PhD in progress  ",
      "#ffffff"
    )}${this.wrapWithColor("│", "#ff8c00")}
${this.wrapWithColor(
  "╰──────────────────────────────────────────────────╯",
...
• ${this.wrapWithColor("Node.js", "#ffffff")}  • ${this.wrapWithColor("Express.js", "#ffffff")}  • ${this.wrapWithColor("Hapi", "#ffffff")}  • ${this.wrapWithColor("Firebase", "#ffffff")}  • ${this.wrapWithColor("Cloud Functions", "#ffffff")}  • ${this.wrapWithColor("AWS Lambda", "#ffffff")}  • ${this.wrapWithColor("NGINX", "#ffffff")}  • ${this.wrapWithColor("Fly.io", "#ffffff")}

${this.wrapWithColor("Cloud & DevOps:", "#00ffff")}
• ${this.wrapWithColor("Google Cloud", "#ffffff")}  • ${this.wrapWithColor("AWS", "#ffffff")}  • ${this.wrapWithColor("Azure", "#ffffff")}  • ${this.wrapWithColor("Docker", "#ffffff")}  • ${this.wrapWithColor("Kubernetes", "#ffffff")}  • ${this.wrapWithColor("Terraform", "#ffffff")}  • ${this.wrapWithColor("Cloudflare", "#ffffff")}

${this.wrapWithColor("Databases:", "#00ffff")}
• ${this.wrapWithColor("MongoDB", "#ffffff")}  • ${this.wrapWithColor("PostgreSQL", "#ffffff")}  • ${this.wrapWithColor("Supabase", "#ffffff")}  • ${this.wrapWithColor("Redis", "#ffffff")}  • ${this.wrapWithColor("Firestore", "#ffffff")}  • ${this.wrapWithColor("RethinkDB", "#ffffff")}  • ${this.wrapWithColor("BigQuery", "#ffffff")}

${this.wrapWithColor("Tools:", "#00ffff")}
• ${this.wrapWithColor("Git", "#ffffff")}  • ${this.wrapWithColor("Elasticsearch", "#ffffff")}  • ${this.wrapWithColor("GraphQL", "#ffffff")}  • ${this.wrapWithColor("VSCode", "#ffffff")}  • ${this.wrapWithColor("Claude Code", "#ffffff")}`;
...
${this.wrapWithColor("✉", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="mailto:mbosinwa@portalsolutions.ng" style="color: #ffffff; text-decoration: none;">mbosinwa@portalsolutions.ng</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("⚡", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="https://github.com/mbosinwa" target="_blank" style="color: #ffffff; text-decoration: none;">github.com/mbosinwa</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("💼", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="https://linkedin.com/in/mbosinwa" target="_blank" style="color: #ffffff; text-decoration: none;">linkedin.com/in/mbosinwa</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("╰────────────────────────────────────────╯", "#ff8c00")}`;
  ...
  loadProjects() {
    this.projects = [
      ...
      {
        title: "Portal Solutions Web Profile",
        description: "Portal Solutions is a Port Harcourt technology company",
        image: "https://portalsolutions.ng/og-image.png",
